        ...
        <div class="col-lg-6">
          <div class="testimonials-one__content">
            <div class="block-title text-left">
              <h2 class="block-title__title light-text-color">
                What our clients <br />
                are saying
              </h2>
              <!-- /.block-title__title -->
                  ...
                  <div class="item">
                    <div class="testimonials-one__single" data-thumb-img="images/testi-1-1.jpg">
                      <p class="testimonials-one__text">
                        ...
                        refresing to get such a personal touch. Duis aute irure dolor in reprehenderit in voluptate
                      ...
                      <div class="testimonials-one__bottom">
                        ...
                        <div class="testimonials-one__sep">.</div>
                        <!-- /.testimonials-one__sep -->
                        <p class="testimonials-one__designation">CEO Lums</p>
...
<style scoped>
.testimonials-one__image-block.swiper-container {
  height: 500px;
}
</style>
